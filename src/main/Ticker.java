...
public class Ticker extends Thread
{
	...
	private Ticker.Listener mParent = null;
	...
	public Ticker(Ticker.Listener parent)
	{
		this.mParent = parent;
		return;
	}
	
	public Ticker(Ticker.Listener parent, double updateHertz, double renderHertz, int maxUpdates)
	{
		this.mParent = parent;
	...
	public void run()
	{
		...
		while(!this.mStopRequested)
		{
			...
			{
				this.mParent.tickerUpdateRequested();
				...
				this.mParent.tickerRenderRequested();
